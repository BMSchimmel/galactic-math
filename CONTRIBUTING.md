...
2. If no Linear issue exists for the work, create one and assign it to the **"Galactic Math"** project before starting.
3. Confirm you are on `main` and it is up to date: `git pull origin main`
